...
from fastocr.tool.translate import build_model, process_input_batch, translate
...
class Predictor:
    ...
    def predict_batch(self, imgs):
        ...
        if torch.cuda.is_available():
            ...
            logging.info(
                "[gpu-mem] FastOCR predict_batch(%d crops): allocated=%.0fMB reserved=%.0fMB -> %.0fMB after empty_cache()",
